<template>
    <div ref="containerRef" class="w-full h-[500px] bg-[#00ffff]  relative overflow-auto touch-auto" @scroll="ScrollEvent">
...
const itemDate = props.itemDate.map((item, index) => ({ index, ...item }));
